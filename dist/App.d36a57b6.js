  ...
  _createClass(Pet, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          location = _this$props.location; // photos come back kind of funny
...
var petfinder = (0, _petfinderClient.default)({
  key: "2ebf8ad4a7080e6832b7ac37edce94a7",
  secret: "ce8d47377db8fa8c929465ab552cd7cd"
});
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      petfinder.pet.find({
        ...
        var pets; // check if pets returned something

        if (data.petfinder.pets && data.petfinder.pets.pet) {
          // check if it found more than one pet else
          if (Array.isArray(data.petfinder.pets.pet)) {
            pets = data.petfinder.pets.pet; //return the one pet but still in an array
          } else {
        ...
        _this2.setState({
          pets: pets
        }); // same as this this.setState({ pets: pets })
    ...
    key: "render",
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h1", null, "Adopt a Pet!"), _react.default.createElement("div", null, this.state.pets.map(function (pet) {
